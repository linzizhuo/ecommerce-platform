...
public class AdminController {
    ...
    @Resource private com.cloudmall.service.impl.ConfigService configService;
    ...
    public R<List<SystemConfig>> configList() {
        return R.ok(configService.allConfigs());
    }

    @PostMapping("/config")
    public R<Void> updateConfig(@RequestBody SystemConfig config) {
    ...
    public R<List<Notice>> noticeList() {
        return R.ok(configService.listNotices());
    }

    @PostMapping("/notice")
    public R<Void> saveNotice(@RequestBody Notice notice) {
